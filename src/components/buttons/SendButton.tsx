...
export const SendButton = (props: SendButtonProps) => {
  return (
    <button
      ...
      {...props}
      class={
        'justify-center font-semibold text-black focus:outline-none flex items-center disabled:cursor-not-allowed disabled:brightness-100 transition-all filter hover:brightness-90 active:brightness-75 chatbot-button ' +
        props.class
      }
