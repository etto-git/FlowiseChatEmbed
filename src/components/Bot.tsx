      ...
      >
        ...
        <div class="mem5 flex flex-col w-full h-full justify-start z-0">
          ...
          <div
            part="memu-5"
            ref={chatContainer}
            class="overflow-y-scroll flex flex-col flex-grow px-3 pt-[70px] relative scrollable-container chatbot-chat-view scroll-smooth"
          >
            <For each={[...messages()]}>
              {(message, index) => {
                return (
...
//   ref: HTMLDivElement | undefined; <Badge badgeBackgroundColor={props.badgeBackgroundColor} poweredByTextColor={props.poweredByTextColor} botContainer={botContainer} />
// };
